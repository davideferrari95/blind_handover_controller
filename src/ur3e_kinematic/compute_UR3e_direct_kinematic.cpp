...
// Eigen::Matrix<double, 4, 4> compute_UR3e_direct_kinematic(Eigen::Matrix<double, 6, 1> q){
extern "C" void compute_UR3e_direct_kinematic(double* result, double *q) {
...
T(0,3) = sin(q0)*1.3105E-1-cos(q0)*cos(q1)*2.4355E-1+cos(q4)*sin(q0)*9.21E-2-sin(q4)*(cos(q3)*(cos(q0)*cos(q1)*cos(q2)-cos(q0)*sin(q1)*sin(q2)*1.0)-sin(q3)*(cos(q0)*cos(q1)*sin(q2)*1.0+cos(q0)*cos(q2)*sin(q1)*1.0)*1.0)*9.21E-2+sin(q3)*(cos(q0)*cos(q1)*cos(q2)-cos(q0)*sin(q1)*sin(q2)*1.0)*8.535E-2+cos(q3)*(cos(q0)*cos(q1)*sin(q2)*1.0+cos(q0)*cos(q2)*sin(q1)*1.0)*8.535E-2-cos(q0)*cos(q1)*cos(q2)*2.132E-1+cos(q0)*sin(q1)*sin(q2)*2.132E-1;
...
T(1,3) = cos(q0)*-1.3105E-1-cos(q0)*cos(q4)*9.21E-2+cos(q3)*(cos(q1)*sin(q0)*sin(q2)*1.0+cos(q2)*sin(q0)*sin(q1)*1.0)*8.535E-2-cos(q1)*sin(q0)*2.4355E-1-sin(q3)*(sin(q0)*sin(q1)*sin(q2)*1.0-cos(q1)*cos(q2)*sin(q0)*1.0)*8.535E-2+sin(q4)*(cos(q3)*(sin(q0)*sin(q1)*sin(q2)*1.0-cos(q1)*cos(q2)*sin(q0)*1.0)*1.0+sin(q3)*(cos(q1)*sin(q0)*sin(q2)*1.0+cos(q2)*sin(q0)*sin(q1)*1.0)*1.0)*9.21E-2+sin(q0)*sin(q1)*sin(q2)*2.132E-1-cos(q1)*cos(q2)*sin(q0)*2.132E-1;
...
T(2,3) = sin(q1)*-2.4355E-1-cos(q1)*sin(q2)*2.132E-1-cos(q2)*sin(q1)*2.132E-1-sin(q4)*(cos(q3)*(cos(q1)*sin(q2)*1.0+cos(q2)*sin(q1)*1.0)+sin(q3)*(cos(q1)*cos(q2)*1.0-sin(q1)*sin(q2)*1.0))*9.21E-2-cos(q3)*(cos(q1)*cos(q2)*1.0-sin(q1)*sin(q2)*1.0)*8.535E-2+sin(q3)*(cos(q1)*sin(q2)*1.0+cos(q2)*sin(q1)*1.0)*8.535E-2+1.5185E-1;
